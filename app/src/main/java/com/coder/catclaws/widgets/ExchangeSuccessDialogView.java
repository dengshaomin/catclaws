...
public class ExchangeSuccessDialogView extends BaseLayout {
    ...
    public ExchangeSuccessDialogView(Context context) {
        super(context);
    }

    public ExchangeSuccessDialogView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ExchangeSuccessDialogView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @Override
    public int setContentLayout() {
        return R.layout.exchangesuccess_dialogview;
    }
