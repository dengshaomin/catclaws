...
public class SmartPlayerJni {
     ...
     *
     * @param handle:         return value from SmartPlayerInit()
     * @param use_audiotrack: <pre> NOTE: if use_audiotrack with 0: it will use auto-select output devices; if with 1: will use audiotrack mode. </pre>
     * @return {0} if successful
     */
     ...
     *
     * @param handle: return value from SmartPlayerInit()
     * @param buffer: <pre> NOTE: Unit is millisecond, range is 200-5000 ms </pre>
     * @return {0} if successful
     */
